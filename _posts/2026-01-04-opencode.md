---
layout: post
title: Devinぽいことを自前でローカルでさせたくてOpenCodeを試していた
date: 2026-01-04 20:00 +0900
---

Devinも良いのだけど、挙動をチューニングできる自前のエージェントが欲しくてOpenCodeを試していた。Devinだと（Askはともかく）セッション起動に時間がかかるし値段も高いので重いタスクをずっと動かし続けるのに躊躇するという理由もある。
